...
static void close_cb(AppChooserDialog* dialog, gpointer data) {
    GAppInfo* info;
...
int main(int argc, char* argv[]) {
    ...
    GOptionEntry entries[] = {
        ...
        {"location", 0, 0, G_OPTION_ARG_STRING, &location, "The location (file or uri)",
         "LOCATION"},
        {
            NULL,
        }};
