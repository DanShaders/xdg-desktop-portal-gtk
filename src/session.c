...
G_DEFINE_TYPE_WITH_CODE(Session, session, XDP_IMPL_TYPE_SESSION_SKELETON,
                        G_IMPLEMENT_INTERFACE(XDP_IMPL_TYPE_SESSION, session_skeleton_iface_init))

#define SESSION_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS((o), session_get_type(), SessionClass))
...
static void session_set_property(GObject* object, guint prop_id, GValue const* value,
                                 GParamSpec* pspec) {
    Session* session = (Session*) object;
...
static void session_get_property(GObject* object, guint prop_id, GValue* value, GParamSpec* pspec) {
    Session* session = (Session*) object;
...
static void session_constructed(GObject* object) {
    Session* session = (Session*) object;
