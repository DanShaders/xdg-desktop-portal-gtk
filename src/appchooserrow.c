...
static void app_chooser_row_init(AppChooserRow* row) {
    gtk_widget_init_template(GTK_WIDGET(row));
}

static void app_chooser_row_finalize(GObject* object) {
...
static void app_chooser_row_class_init(AppChooserRowClass* class) {
    ...
    gtk_widget_class_set_template_from_resource(
        widget_class, "/org/freedesktop/portal/desktop/gtk/appchooserrow.ui");
